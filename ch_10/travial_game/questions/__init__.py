...
for key, value in question_dictionary.items():
    print(player.title())
    player_choice = None
    count = 1
    print(f"{key}")
...
print(f"Player 1: {player_1} points")
print(f"Player 2: {player_2} points")
if player_1 == player_2:
    print("Draw")
elif player_1 > player_2:
    print(f"{player.title()} wins by {player_1 - player_2} points.")
else:
    print(f"{player.title()} wins by {player_2 - player_1} points.")


# while len(question_dictionary) > 0:
#     random_key = random.choice(list(question_dictionary.keys()))
#     print(f"{len(question_dictionary)}: {random_key}\n")
#     del question_dictionary[random_key]
